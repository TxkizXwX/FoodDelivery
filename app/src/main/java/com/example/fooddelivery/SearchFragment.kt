...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list = ArrayList()
        list.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
        list.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = "9$"))
        list.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = "5$"))
        list.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
        list.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = "9$"))
        list.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = "5$"))
        list.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
