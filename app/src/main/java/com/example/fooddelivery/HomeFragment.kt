...
private lateinit var goMenuText : TextView
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = 9,9, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = 5,5, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = 9,9, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = 5,5, 1))
        listPopular.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
