...
class MenuBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        menuList = ArrayList()
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = 9,9, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = 5,5, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = 9,9, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = 5,5, 1))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = 3,3, 1))
