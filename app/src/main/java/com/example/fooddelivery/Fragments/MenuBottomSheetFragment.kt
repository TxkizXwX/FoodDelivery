...
class MenuBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        menuList = ArrayList()
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = "9$"))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = "5$"))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
        menuList.add(PopularModel(R.drawable.pop_menu_momo, foodName = "Double Burger", foodPrice = "9$"))
        menuList.add(PopularModel(R.drawable.pop_menu_sandwich, foodName = "Khinkali", foodPrice = "5$"))
        menuList.add(PopularModel(R.drawable.pop_menu_burger, foodName = "Sandwich", foodPrice = "3$"))
